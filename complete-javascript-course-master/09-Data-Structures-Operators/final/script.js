...
//? My method without the checks and forgetting how to access the values.
// const camelCase = function (variable) {
//   const lowerCase = variable.toLowerCase().trim().split('_');
//   const [first, second] = lowerCase;
//   const capitalized =
//     first.slice(0) + second[0].toUpperCase() + second.slice(1);
...
// //? non ternary, evaluates first falsey statement
